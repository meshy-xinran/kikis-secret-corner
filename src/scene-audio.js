export function createSceneAudio(){
 const button=document.createElement('button');button.className='sound-toggle';button.dataset.recommend='true';button.textContent='♫ Enable sound\nHighly recommended';button.setAttribute('aria-label','Enable ambient sound');document.body.append(button);
 ...
 async function start(){
  if(loading)return;loading=true;button.dataset.recommend='false';button.textContent='♫ Loading…';
  try{
   setup();
