export function createSceneAudio(){
 const button=document.createElement('button');button.className='sound-toggle';button.textContent='♫ Enable sound — highly recommended';button.setAttribute('aria-label','Enable ambient sound');document.body.append(button);
